...
public class AdminMainPage extends JFrame {
    ...
    private void openMenuView() {
        ...
        MenuView.showMenuView(userManager, onSuccess); // Open MenuView
    }

    private void openTablesView() {
        JOptionPane.showMessageDialog(this, "Tables View Opened!");
    }
    ...
    private void openInventoryView() {
        JOptionPane.showMessageDialog(this, "Inventory View Opened!");
    }

    private void openUserSetupView() {
        JOptionPane.showMessageDialog(this, "User Setup View Opened!");
    }
    ...
    private void openSupportSite() {
        JOptionPane.showMessageDialog(this, "Opening Support Site...");
    }
